...
const underwritingProcessJobAid: LessonJobAid = {
  title: "UW Process/Internal Process",
  href: "https://kb.dash.fi/doc/uw-process-internal-process-2m3IlLBz2i",
  requirement:
    "Open this KB job aid and star/save it to your KB collection before completing Module 3.",
};
...
> = {
    ...
    checkpoints: [
      {
        ...
        options: [
          ...
          },
          {
            ...
            correct: true,
            feedback:
              "Correct. $3M minus $4.5M leaves negative $1.5M.",
          },
        ],
      },
      {
    ...
    "sections": [
        {
            ...
            "stageCopy": "Net-1 is a lighter path. Extended terms need a fuller financial packet before underwriting can calibrate risk."
        },
        {
            "id": "section-2",
            ...
            "stageCopy": "Extended terms require 24 months of P&L and balance sheet because Dash.fi is carrying more repayment exposure."
        },
        {
            "id": "section-3",
            ...
            "stageCopy": "Underwriting reads the numbers first, then uses the call to understand what the numbers do not fully explain."
        },
        {
            "id": "section-4",
            "title": "Cash runway",
            ...
            "stageCopy": "For extended terms, underwriting wants enough cash on hand relative to the requested limit."
        },
        {
            "id": "section-5",
            "title": "Current ratio",
            ...
            "stageCopy": "A weak current ratio is one of the fastest ways a prospect will not qualify for Net-30 or above."
        },
        {
            "id": "section-6",
            ...
            "stageCopy": "Existing financing is not automatically bad. Underwriting wants to know whether debt is shrinking or growing."
        },
        {
            "id": "section-7",
            ...
            "stageCopy": "Revenue trajectory is about whether the company is moving toward profitability or still burning cash."
        },
        {
            "id": "section-8",
            ...
            "stageCopy": "Parent entities can change the path if the parent controls the balance sheet or can support the application."
        },
        {
            "id": "section-9",
            ...
            "stageCopy": "The rep's job is to set the right path early so underwriting is not surprised later."
        }
    ],
    "checkpoints": [
        {
            ...
            "placement": 43.42,
            "question": "What does the underwriting team need to approve a Net-1 card path?",
        ...
        },
        {
            ...
            "placement": 288.065,
            "question": "Which item is NOT one of the five extended-term evaluation categories?",
            ...
            "options": [
                ...
                },
                {
                    ...
                    "feedback": "Revenue trajectory is one of the core evaluation categories."
                }
            ]
        }
    ],
    ...
    "sections": [
        {
            ...
            "stageCopy": "The lesson starts with the cost of missing risk patterns: multiple deals, one avoidable exposure story."
        },
        {
            "id": "section-2",
            "title": "Obvious signs",
            ...
            "stageCopy": "You are not underwriting on the call. You are catching the obvious signals early enough to avoid wasted motion."
        },
        {
            "id": "section-3",
            ...
            "stageCopy": "Recent bankruptcy or financial distress should change the conversation before a deal reaches underwriting."
        },
        {
            "id": "section-4",
            ...
            "stageCopy": "If a parent company controls the money, the operating entity's revenue may not tell the repayment story."
        },
        {
            "id": "section-5",
            "title": "Thin margins",
            ...
            "stageCopy": "Thin margin businesses can look large while having very little cushion for repayment timing or a bad month."
        },
        {
            "id": "section-6",
            ...
            "stageCopy": "A young company with high debt and low cash may not be ready for the limits it wants."
        },
        {
            "id": "section-7",
            ...
            "stageCopy": "The goal is not to underwrite on the sales call. It is to spot obvious non-fits before the request is packaged."
        },
        {
            "id": "section-8",
            "title": "Module wrap",
            ...
            "stageCopy": "Financial vocabulary and pattern recognition set up the discovery process in the next module."
        }
    ],
    "checkpoints": [
        {
            ...
            "placement": 109.6,
            "question": "A prospect buys discounted products and resells them on Amazon at a small markup. Why is this a concern?",
            "reviewTarget": "Thin margins",
            "options": [
                {
                    "id": "a",
                    "text": "Amazon sellers are never a fit.",
                    "feedback": "The issue is the margin profile, not the channel by itself."
                },
                {
                    "id": "b",
        ...
        },
        {
            ...
            "placement": 59.305,
            "question": "True or false: recent bankruptcy can be outweighed by strong current revenue for Dash.fi fit.",
            ...
            "options": [
                {
                    ...
                    "text": "True.",
                    "correct": false,
                    "feedback": "Review this section. The lesson makes a narrower point than that."
                },
                {
                    "id": "b",
                    "text": "False.",
                    "correct": true,
                    "feedback": "Correct. Recent bankruptcy is a major financial distress signal in this lesson."
                }
            ]
        }
    ],
    ...
    "sections": [
        {
            ...
            "stageCopy": "Prospects expect FICO pulls, personal guarantees, and low limits. This lesson shows three ways to reframe underwriting as a Dash.fi advantage."
        },
        {
            ...
            "stageCopy": "Name the model, connect it to growth, and anchor the value in business performance: revenue, bank balance, and scalable limits."
        },
        {
            "id": "section-2",
            ...
            "stageCopy": "When prospects mention personal guarantees, FICO pulls, or low limits, contrast that with Dash.fi underwriting the business."
        },
        {
            "id": "section-3",
            ...
            "stageCopy": "Specific language lowers anxiety: no personal guarantee, no personal credit pull, and no UCC lien for the standard path."
        },
        {
            "id": "section-4",
            ...
            "stageCopy": "Frame Net-1 as the lighter path and extended terms as a deeper underwriting review without promising a specific outcome."
        },
        {
            "id": "section-5",
            ...
            "stageCopy": "Move the conversation to the application without promising a limit or term. The rep's job is to set the right path and expectation."
        }
    ],
    "checkpoints": [
        {
            ...
            "label": "Opening frame",
            "placement": 131.376,
            "question": "Which opening move does NOT belong in the recommended financial conversation frame?",
        ...
        },
        {
            ...
            "placement": 311.842,
            "question": "A prospect asks what terms Dash.fi can offer. Which response best protects the deal?",
            ...
            "options": [
                ...
                },
                {
                    ...
                    "feedback": "The lesson supports framing the path, not avoiding the topic."
                }
            ]
        },
        {
            ...
            "label": "Net-1 path",
            "placement": 346.487,
            "question": "True or false: Net-1 applicants need 24 months of P&L and balance sheets.",
            "reviewTarget": "Two product paths",
            "options": [
                {
                    "id": "a",
                ...
                },
                {
                    ...
                    "text": "False.",
                    "correct": true,
                    "feedback": "Correct. That financial statement package applies to extended repayment terms."
                }
            ]
        }
    ],
    ...
    "sections": [
        {
            ...
            "stageCopy": "Financial questions feel risky when they sound like interrogation. Set the purpose first so the prospect understands why the answer matters."
        },
        {
            "id": "section-2",
            ...
            "stageCopy": "A reason turns a sensitive financial question into context. The prospect hears why the answer matters before they react."
        },
        {
            "id": "section-3",
            ...
            "stageCopy": "Start with fit, then ask profitability. Cameron shows how the reason can come before the question without using the exact phrase."
        },
        {
            "id": "section-4",
            ...
            "stageCopy": "When the answer is vague, anchor to the prospect's goal and narrow the question to something easier to answer."
        },
        {
            "id": "section-5",
            ...
            "stageCopy": "When a prospect refuses, validate the concern, explain the reason, and ask a smaller version of the question."
        },
        {
            "id": "section-6",
            ...
            "stageCopy": "Cash position and existing debt questions are easier when they are direct, specific, and framed as product-fit discovery."
        },
        {
            "id": "section-7",
            "title": "Lesson recap",
            ...
            "stageCopy": "Use the reason phrase while asking, after vague answers, and when prospects push back. The goal is context plus lower commitment."
        },
        {
            "id": "section-8",
            ...
            "stageCopy": "Normalize financial discovery by making every question serve the same purpose: finding the right path and avoiding surprises later."
        }
    ],
    "checkpoints": [
        {
            ...
            "placement": 153.346,
            "question": "Why does “the reason I ask is because” make a hard financial question easier to answer?",
            ...
            "options": [
                ...
                },
                {
                    ...
                    "feedback": "The phrase helps you ask financial questions more clearly."
                }
            ]
        },
        {
            ...
            "label": "Vague answer",
            "placement": 245.808,
            "question": "A prospect says, “It is complicated; we are still figuring out cash position.” What should you do?",
            "reviewTarget": "Lower the commitment",
            "options": [
                {
                    "id": "a",
                    "text": "Move on permanently.",
                    "feedback": "The lesson teaches a softer follow-up, not dropping the topic."
                },
                {
                    "id": "b",
    ...
    "sections": [
        {
            ...
            "stageCopy": "The first frame is not the document list. It is the predictable concern: financials, credit checks, personal guarantees, and UCC filings."
        },
        {
            "id": "section-2",
            ...
            "stageCopy": "When Matthew is not comfortable sharing self-prepared books, Andy keeps Net-1 as the first path and leaves extended terms for underwriting review."
        },
        {
            "id": "section-3",
            ...
            "stageCopy": "Lead with the lightweight next step: the application is quick, non-binding, and does not require the full extended-term packet."
        },
        {
            "id": "section-4",
            ...
            "stageCopy": "Put Net-1 first, then explain that extended terms can be explored with underwriting once the heavier document review is relevant."
        },
        {
            "id": "section-5",
            ...
            "stageCopy": "Name PG, credit check, and UCC concerns before they become objections, so the prospect hears confirmation instead of risk."
        },
        {
            "id": "section-6",
            "title": "Lesson recap",
            ...
            "stageCopy": "Minimize the ask, separate easy from hard, and say the things prospects worry about before they have to ask."
        }
    ],
    "checkpoints": [
        {
            ...
            "placement": 114.104,
            "question": "What makes the application feel lighter before concerns surface?",
        ...
        },
        {
            ...
            "placement": 231.921,
            "question": "True or false: when a prospect asks about float, lead with the full document list before they commit.",
            ...
            "options": [
                ...
                },
                {
                    ...
                    "text": "False.",
                    "correct": true,
                    "feedback": "Correct. Keep the ask simple and separate the easy first step from deeper review."
                }
            ]
        }
    ],
    ...
    "sections": [
        {
            ...
            "stageCopy": "Prospects may still push back after you frame the application. Treat the concern as information, not friction."
        },
        {
            "id": "section-2",
            ...
            "stageCopy": "When a concern surfaces, make the prospect feel heard before you give the direct answer."
        },
        {
            "id": "section-3",
            ...
            "stageCopy": "Guy asks whether signing up means a massive contract, personal guarantee, or liability exposure."
        },
        {
            "id": "section-4",
            ...
            "stageCopy": "He validates the founder concern, aligns to Dash.fi's values, then gives the structural answer."
        },
        {
            "id": "section-5",
            ...
            "stageCopy": "The prospect feels heard before they get the information: validate the concern, align on values, then answer."
        },
        {
            "id": "section-6",
            ...
            "stageCopy": "Give the shortest direct answer, then replace concern with a simple next step."
        },
        {
            "id": "section-7",
            ...
            "stageCopy": "Kurt and Tim both answer the credit-check concern first, then pivot to how lightweight Net-1 is."
        },
        {
            "id": "section-8",
            ...
            "stageCopy": "When the person on the call cannot or will not share personal information, redirect to the right stakeholder."
        },
        {
            "id": "section-9",
            ...
            "stageCopy": "Vijay refuses to share personal KYC information, so Cameron stops repeating the explanation and redirects ownership."
        },
        {
            "id": "section-10",
            ...
            "stageCopy": "Personal discomfort can be redirected. Company policy, governance, or board approval is structural and needs a different path."
        },
        {
            "id": "section-11",
            ...
            "stageCopy": "Use the three tactics on personal concerns: discomfort with documents, worry about credit checks, and hesitation about personal guarantees."
        },
        {
            "id": "section-12",
            "title": "Keep momentum",
            ...
            "stageCopy": "The goal is not to win every concern. It is to choose the right next move: push for float, pivot to Net-1, or flag it for underwriting."
        }
    ],
    "checkpoints": [
        {
            ...
            "placement": 156.315,
            "question": "A prospect asks whether there is a personal guarantee. What pattern should you use?",
        ...
        },
        {
            ...
            "placement": 253.698,
            "question": "A prospect says their board must approve sharing financial data. What kind of concern is this?",
            ...
            "options": [
                ...
                },
                {
                    ...
                    "feedback": "The lesson supports routing the concern, not ending the deal."
                }
            ]
        }
    ],
    ...
    "sections": [
        {
            ...
            "stageCopy": "The goal is to read the signal early: float fit, Net-1 close, or a deal that should not move to underwriting yet."
        },
        {
            "id": "section-2",
            ...
            "stageCopy": "Start with the financial signals that tell you whether float is supportable or Net-1 is the cleaner path."
        },
        {
            "id": "section-3",
            ...
            "stageCopy": "If the founder is still swiping a personal card for Meta campaigns, the business may not have its own financial infrastructure yet."
        },
        {
            "id": "section-4",
            ...
            "stageCopy": "Burn greater than revenue with a short runway is not always a dead deal, but it is a strong signal that Net-1 may be the only responsible path."
        },
        {
            "id": "section-5",
            ...
            "stageCopy": "A financial signal can point to a Net-1 close while the company's profile strengthens."
        },
        {
            "id": "section-6",
            ...
            "stageCopy": "Revenue is not the only predictor. Some business models create cash-cycle pressure that makes extended terms harder to support."
        },
        {
            "id": "section-7",
            "title": "Resellers",
            ...
            "stageCopy": "Resellers can move product they do not fully control, which can leave underwriting with less asset support behind float."
        },
        {
            "id": "section-8",
            "title": "Distributors",
            ...
            "stageCopy": "Distributors can carry stretched supplier and customer-payment cycles, so the cash conversion cycle needs to be flagged early."
        },
        {
            "id": "section-9",
            "title": "Dropshippers",
            ...
            "stageCopy": "Dropshippers may sell before owning or holding inventory. When cash goes out before downstream buyers pay, float support can get thin."
        },
        {
            "id": "section-10",
            "title": "Manufacturers",
            ...
            "stageCopy": "R&D, tooling, production runs, and overseas shipping can make cash conversion lag far behind revenue."
        },
        {
            "id": "section-11",
            ...
            "stageCopy": "Agencies, 3PLs, and staffing companies may pay teams every two weeks while client revenue comes back on Net-30 or Net-60."
        },
        {
            "id": "section-12",
            ...
            "stageCopy": "A brand can look like an ICP fit, but if ad spend is ahead of profitability, the cash conversion cycle is still negative."
        },
        {
            "id": "section-13",
            ...
            "stageCopy": "Just flag them early and set the right expectations before the prospect fills out the application."
        }
    ],
    "checkpoints": [
        {
            ...
            "placement": 76.534,
            "question": "A founder uses a personal Amex for all Meta ads. What does this signal?",
        ...
        },
        {
            ...
            "placement": 192.079,
            "question": "Why can service companies like agencies or staffing firms struggle with float approval?",
    ...
    "sections": [
        {
            ...
            "stageCopy": "The application verifies KYB and KYC. Underwriting is the separate step that determines terms and limits."
        },
        {
            "id": "section-2",
            ...
            "stageCopy": "The prospect confirms whether this is a US company with a registration number and legal operating entity."
        },
        {
            "id": "section-3",
            ...
            "stageCopy": "Company details, monthly spend, website, and operating address. EIN and incorporation documents keep this step moving."
        },
        {
            "id": "section-4",
            ...
            "stageCopy": "Beneficial owners over 25%, or the controlling officer, complete KYC with government ID and selfie verification."
        },
        {
            "id": "section-5",
            ...
            "stageCopy": "This is standard legal acceptance, not final underwriting terms."
        },
        {
            "id": "section-6",
            ...
            "stageCopy": "The final screen confirms beneficiaries, controlling officer, bank account, and documents."
        },
        {
            "id": "section-7",
            ...
            "stageCopy": "Fastest path: the prospect authenticates through Plaid and the bank connection verifies instantly."
        },
        {
            "id": "section-8",
            ...
            "stageCopy": "The prospect enters routing and account numbers, then verifies the account with a micro deposit."
        },
        {
            "id": "section-9",
            ...
            "stageCopy": "Last path: upload a recent bank statement directly in the application. It must be an actual statement, not a screenshot."
        },
        {
            "id": "section-10",
            "title": "Documents",
            ...
            "stageCopy": "Net-1 may only need a bank statement. Float review is where 24 months of P&L and balance sheets get attached."
        },
        {
            "id": "section-11",
            ...
            "stageCopy": "Operations completes KYB and KYC review. Once approved, the system creates an underwriting request for the separate terms-and-limits decision."
        },
        {
            "id": "section-12",
            ...
            "stageCopy": "Application approved does not mean the prospect has a card yet. It means the business is verified and ready for underwriting."
        }
    ],
    "checkpoints": [
        {
            ...
            "placement": 53.638,
            "question": "True or false: once the application is approved through KYB and KYC business verification, the prospect has final card terms and limits and the card is ready to use.",
            ...
            "options": [
                {
                    ...
                    "text": "True.",
                    "correct": false,
                    "feedback": "Application approval does not mean the prospect has a card yet. It means the business has been verified and is ready for underwriting."
                },
                {
                    "id": "b",
                    "text": "False.",
                    "correct": true,
                    "feedback": "Correct. Application approval means KYB and KYC passed. Terms, limits, and card availability come after underwriting."
                }
            ]
        },
        {
            ...
            "label": "KYC ownership",
            "placement": 133.562,
            "question": "A company has four equal co-founders at 25% each. Who completes KYC verification?",
            "reviewTarget": "Document handoff",
            "options": [
                {
                    "id": "a",
                    "text": "Only the person on the sales call.",
                    "feedback": "KYC depends on ownership/control, not just meeting attendance."
                },
                {
                    "id": "b",
                ...
                },
                {
                    ...
                    "feedback": "Bank connection does not replace required identity verification."
                }
            ]
        },
        {
            ...
            "placement": 221.939,
            "question": "A prospect says Plaid cannot connect to their bank. What is the next option?",
            ...
            "options": [
                ...
                },
                {
                    ...
                    "correct": true,
                    "feedback": "Correct. If Plaid does not connect, the next path is manual bank entry followed by micro-deposit verification."
                },
                {
                    "id": "c",
                    "text": "Tell them underwriting cannot continue under any circumstances.",
                    "feedback": "The application process has alternatives before that conclusion."
                }
            ]
        }
    ],
  ...
  "3-1": {
    ...
    "jobAid": underwritingProcessJobAid,
    "sections": [
        {
            "id": "section-1",
            ...
            "stageCopy": "Watch how the HubSpot request moves from qualified deal to underwriting submission."
        }
    ],
    "productionNotes": [
    ...
    "sections": [
        {
            ...
            "stageCopy": "Watch how the request status, review outcome, and deal updates move through HubSpot."
        }
    ],
    "productionNotes": [
    ...
    "sections": [
        {
            ...
            "stageCopy": "Watch how to create a manual limit increase request on the existing deal."
        }
    ],
    "productionNotes": [
